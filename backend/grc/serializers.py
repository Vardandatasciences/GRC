...
class FrameworkSerializer(serializers.ModelSerializer):
    class Meta:
        model = Framework
        fields = ('FrameworkId', 'FrameworkName', 'Category', 'ActiveInactive', 'FrameworkDescription')
...
class SubPolicySerializer(serializers.ModelSerializer):
    class Meta:
        model = SubPolicy
        fields = ('SubPolicyId', 'SubPolicyName', 'Status', 'Description', 'Control', 'Identifier', 'PermanentTemporary', 'Policy_id', 'CreatedByName', 'CreatedByDate')

class ComplianceListSerializer(serializers.ModelSerializer):
    class Meta:
        model = Compliance
        fields = ('ComplianceId', 'ComplianceItemDescription', 'Status', 'Criticality', 'MaturityLevel', 'ActiveInactive', 'ComplianceVersion', 'CreatedByName', 'CreatedByDate', 'Identifier', 'IsRisk', 'MandatoryOptional', 'ManualAutomatic')
...
class FrameworkVersionSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'VersionId', 'FrameworkId', 'Version', 'FrameworkName',
            'CreatedBy', 'CreatedDate', 'PreviousVersionId'
        ]
...
class PolicyVersionSerializer(serializers.ModelSerializer):
    class Meta:
        model = PolicyVersion
        fields = [
            'VersionId', 'PolicyId', 'Version', 'PolicyName',
            'CreatedBy', 'CreatedDate', 'PreviousVersionId'
        ]
...
class SubPolicySerializer(serializers.ModelSerializer):
    class Meta:
        model = SubPolicy
        fields = ['SubPolicyId', 'SubPolicyName', 'Status', 'Description', 'Control']
...
class FrameworkSerializer(serializers.ModelSerializer):
    ...
    def get_policies(self, obj):
        ...
        policies = obj.policies.filter(Status='Approved', ActiveInactive='Active')
...
class PolicyApprovalSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ReviewerId', 'Version', 'ApprovedNot', 'ApprovedDate'
        ]
