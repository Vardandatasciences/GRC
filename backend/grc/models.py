...
class Risk(models.Model):
    ...
    RiskLikelihood = models.IntegerField(max_length=50, null=True)
    RiskImpact = models.IntegerField(max_length=50, null=True)
...
class RiskInstance(models.Model):
    ...
    RiskMitigation = models.JSONField(null=True)
    ...
    RiskFormDetails = models.JSONField(null=True)
