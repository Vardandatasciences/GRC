      ...
      <table class="risk-table">
        ...
        <tbody>
          <tr v-for="risk in risks" :key="risk.RiskInstanceId" :class="getRowClass(risk.RiskStatus)">
            ...
            <td>
              <!-- If risk is assigned, just show the user name -->
              <div v-if="risk.RiskOwner && risk.RiskOwner !== 'System User'">
                {{ risk.RiskOwner }}
              </div>
              <!-- If risk is unassigned or assigned to System User, show assignment option -->
