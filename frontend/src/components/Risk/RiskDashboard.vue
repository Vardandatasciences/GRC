 <template>
  <div class="dashboard-container">
    ...
    <div class="dashboard-filters">
      ...
      <div class="filter-group">
        <label>X-Axis</label>
        <select v-model="selectedXAxis" class="filter-select" @change="updateChartData(selectedXAxis, selectedYAxis)">
      ...
      <div class="filter-group">
        <label>Y-Axis</label>
        <select v-model="selectedYAxis" class="filter-select" @change="updateChartData(selectedXAxis, selectedYAxis)">
