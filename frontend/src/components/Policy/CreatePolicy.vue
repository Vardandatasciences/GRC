...
export default {
  ...
  setup(props) {
    ...
    // Add function to get the title based on mode
    const getPageTitle = () => {
      if (props.mode === 'tailoring') return 'Policy Tailoring & Templating';
      if (props.mode === 'versioning') return 'Policy Versioning';
