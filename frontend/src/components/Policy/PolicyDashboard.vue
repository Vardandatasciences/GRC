  ...
  <div class="dashboard-container">
    ...
    <div class="summary-tabs">
      ...
      >
        ...
        <div class="summary-tab-content">
          <div class="summary-tab-label">Total Policies</div>
          <div class="summary-tab-value">{{ dashboardData.total_policies }}</div>
          <div class="summary-tab-trend positive">
            <i class="fas fa-arrow-up"></i>
            {{ dashboardData.active_policies }} active
          </div>
        </div>
      </button>
  ...
  setup() {
    ...
    const getYAxisLabel = (yAxis) => {
      switch(yAxis) {
        ...
        case 'category': return 'Category Distribution'
