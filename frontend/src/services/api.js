...
export const complianceService = {
  ...
  getComplianceStatusOverview: () => api.get('/compliance/kpi-dashboard/analytics/status-overview/'),
  getReputationalImpact: () => api.get('/compliance/kpi-dashboard/analytics/reputational-impact/'),
  ...
  getOntimeMitigationPercentage: () => api.get('/compliance/kpi-dashboard/analytics/ontime-mitigation/'),
};
